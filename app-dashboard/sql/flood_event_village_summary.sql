...
--   Make a table that aggregates village flooded building counts
...
--  aggregate by village and flood_event_id
         group by district_id, sub_district_id, village_id, flood_event_id
     ),
